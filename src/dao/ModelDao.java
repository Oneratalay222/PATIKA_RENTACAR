...
public class ModelDao {
    ...
    public boolean save(Model model) {
        ...
        try {
            ...
            pr.setString(3, String.valueOf(model.getType().toString()));
            pr.setString(4, model.getYear());
            pr.setString(5, String.valueOf(model.getFuel().toString()));
            pr.setString(6, String.valueOf(model.getGear().toString()));
    ...
    public boolean update(Model model) {
        String query = "UPDATE public_model SET"+
                "model_brand_id" +
                "model_name" +
                "model_type" +
                "model_year" +
        ...
        //int model_id = 0 yazıyordu hayatı orada aldım sılınce duzeldi...
        try {
            PreparedStatement pr = con.prepareStatement(query);
