...
public class BookingView extends Layout {
    ...
    public BookingView(Car selectedCar , String strt_date,String fnsh_date) throws SQLException {
        ...
        this.fld_book_name.setText("Öner atalay");
        this.fld_book_idno.setText("12");
        this.fld_book_mail.setText("tes@tes");
        this.fld_book_mpno.setText("123123");
        this.fld_book_prc.setText("123");
        this.txta_book_note.setText("Nor bırakmak ıcın buraya yazıyoruz");
